...
import { color, rotate360 } from "../../identity";
...
const SpinnerWrapper = styled.div<SpinnerProps>`
  ...
  ${(props) =>
    props.type === SpinnerTypes.INVERSE &&
    css`
      border-color: rgba(255, 255, 255, 0.2);
      border-top-color: rgba(255, 255, 255, 0.4);
    `};
  ${(props) =>
    props.type === SpinnerTypes.INFORM &&
    css`
      margin-top: -6px;
      margin-left: -6px;
      height: 12px;
    ...
    `};
  ${(props) =>
    props.type === SpinnerTypes.INLINE &&
    css`
      position: relative;
      top: initial;
      left: initial;
...
export const Spinner: FC<SpinnerProps> = ({ type, ...props }) => {
  return (
    <SpinnerWrapper
      type={type}

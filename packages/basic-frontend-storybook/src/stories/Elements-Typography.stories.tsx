...
export const defaultStory = () => (
  <div className="flex flex-col">
    ...
    <TextRegular>
      TextRegular: Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod
    ...
    <TextLead>
      TextLead: Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod
      tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et
      accusam et justo duo dolores et ea rebum.
    </TextLead>

...
import { ArticleSection, SectionContainer, TextRegular, Title } from 'responsive-it-common';

export default {
  title: 'Design System / Components / Sections',
...
export const unstyledArticleSectionStory = () => (
  <div className="flex flex-col">
    <ArticleSection sectionHeader={simpleHeaderContent} sectionContent={simpleSectionContent} />
  </div>
);
...
export const styledArticleSectionStory = () => (
  <div className="flex flex-col">
    <ArticleSection sectionHeader={styledHeaderContent} sectionContent={styledSectionContent} />
  </div>
);
